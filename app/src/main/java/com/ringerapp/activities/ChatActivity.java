...
import com.ringerapp.adapters.ChatAdapter;
import com.ringerapp.databinding.ActivityChatBinding;
    ...
    private void updateConversion(String message)
             {
                ...
                database.collection(Constants.KEY_COLLECTION_CONVERSATİONS).document(conversionId);
